...
class UserCacheService {
  ...
  final Map<String, StreamController<Map<String, dynamic>>> _userStreamControllers = {};
  ...
  Future<void> _updateCache(String userId, Map<String, dynamic> userData) async {
  ...
  void _setupUserListener(String userId) {
    ...
    if (!_userStreamControllers.containsKey(userId)) {
      _userStreamControllers[userId] = StreamController<Map<String, dynamic>>.broadcast();
    }
