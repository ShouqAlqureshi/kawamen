...
// Ensure this import points to the correct profile screen file
        ...
        child: BlocConsumer<AuthBloc, AuthState>(
          listener: (context, state) {
            if (state is AuthFailure) {
              ...
              // ✅ Navigate to Profile Screen after registration
          ...
          builder: (context, state) {
            return Directionality(
              ...
              child: SingleChildScrollView(
                child: Column(
                  crossAxisAlignment:
                      CrossAxisAlignment.start, // Aligns from the right
                  children: [
                    ...
                    // ✅ Register Button (disabled when unchecked)
                    ElevatedButton(
