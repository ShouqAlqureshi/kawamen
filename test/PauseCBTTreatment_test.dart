...
void main() {
  ...
  testWidgets('Should show dialog and add PauseCBTTreatmentEvent when back button is pressed',
    ...
    expect(find.text('إذا غادرت الآن، ستفقد التقدم في جلسة العلاج الحالية.'), findsOneWidget);
  ...
  testWidgets('Should stay in app when cancel button is pressed in dialog',
    ...
    expect(stayButton, findsOneWidget, reason: 'Stay button not found in the dialog');
